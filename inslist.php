                        ...
                        <table summary=""  class="table_list">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="form_grp form_inline">
                                        <label><input name="radioSample" type="radio" value=""></label>
                                        <select name="" id="selectSample">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="check_grp">
                                        ...
                                        <label><input type="checkbox" value="">中央登錄公債清算銀行經辦行</label>
                                        <label><input type="checkbox" value="">國庫經辦行</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row"><label><input type="checkbox" value="">機構代號<br>(總、分支或管轄單位)</label></th>
                                <td><input type="text" id="insname" placeholder="請輸入機構代號"></td>
                            </tr>
                        </table>
                        <div class="btn_grp">
